...
export const NoteCard = ({id, tags, title}: SimplifiedNote) => {
    console.log(tags)
  return (
<Link to={`/${id}`} className="block h-100 text-reset text-decoration-none transition-transform bg-white p-4 shadow-md rounded-lg duration-100 hover:translate-y-[-5px] hover:shadow-md">
<div className="p-4">
